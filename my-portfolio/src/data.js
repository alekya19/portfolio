...
export const testimonials = [
  {
    quote:
      "TCS Gems award for outstanding performance and contribution to project goals and Service Commitment Award for dedication and commitment to high-quality service.",
  ...
  {
    quote:
      "	MFDM™ AI Aware Badge for proficiency in artificial intelligence and machine learning technologies , Agile Certification for proficiency in agile methodologies.",
...
export const skills = [
  ...
  "GraphQL",
  "Material UI",
  "Angular 2/4/6/7/9/11",
  "Bootstrap",
  "Karma, Jasmine, Developer Tools",
  "Agile, Jira, Rally, scrum",
  "My SQL, Mongo DB, SQL server",
  "Git, Bitbucket",
  "Visual Studio, Eclipse, Eclipse IDE, Firebug, Developer Tools",
  "AWS, GCP developing Client/Server"
];
